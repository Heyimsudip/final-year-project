     ...
     <form onSubmit={handleSubmit}>
      <div className='form-group'>
        ...
        <Select onChange={(value) => setValues({...values, parking: value})} 
          className="w-100 m-2" 
          size='large' 
          placeholder="Enter If  the parking is avaliable or not">
          <Option key={"Yes"}>Yes</Option>
          <Option key={"No"}>No</Option>
        </Select>
        </div>
        ...
        <Select onChange={(value) => setValues({...values, isBooked: value})} 
          className="w-100 m-2" 
          size='large' 
          placeholder="Enter default value as No to post this Room ">
          <Option key={"Yes"}>Yes</Option>
          <Option key={"No"}>No</Option>
        </Select>
        </div>
